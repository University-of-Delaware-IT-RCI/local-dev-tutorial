...
#
# [EDIT] This line is added for this example job, and is not in the
#        template. This defines how many array tasks to use in the job
#        array, and what their IDs are.
#
#SBATCH --array=0-2
#
...
#
srun ./root_finder $SLURM_ARRAY_TASK_ID
